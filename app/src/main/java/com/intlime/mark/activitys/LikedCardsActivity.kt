 ...
 */
class LikedCardsActivity : BaseActivity(), LoadRecyclerView.OnLoadListener {
    private val limit = 10
    private lateinit var lrv: LoadRecyclerView
    private lateinit var myAdapter: LikedCardsAdapter
        ...
        apply {
            rootView = relativeLayout {
                ...
                lrv = LoadRecyclerView(context).apply {
                    ...
                    myAdapter = LikedCardsAdapter(arrayListOf())
                    adapter = myAdapter
                    setRecyclerItemListener(MyRecyclerItemListener())
                    setLoadListener(this@LikedCardsActivity)
    ...
    private fun applyData() {
        ...
        NetManager.getInstance().getLikedMovieCards(0, callback)
    }
    ...
    private inner class LikedCardsAdapter(lists: MutableList<MovieCardBean>) : RecyclerListAdapter<MovieCardBean>(lists) {
        ...
        override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): RecyclerView.ViewHolder? {
            ...
            if (viewHolder == null) {
                viewHolder = Holder(PressableLinearLayout(this@LikedCardsActivity))
            }
            return viewHolder
        }
