...
class RegisterActivity : BaseActivity() {
    ...
    override fun initOther() {
        ...
        next.onClick {
            ...
            NetManager.getInstance().getSMSCode(accountStr, 1, object : NetRequestCallBack() {
                override fun onSuccess(result: ArrayMap<*, *>?) {
                    startActivity<VCodeActivity>("account" to accountStr, "password" to passwd, "type" to 1)
                }
            })
        }
    }
